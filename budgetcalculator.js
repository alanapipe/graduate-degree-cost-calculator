...
function runMath() {
	console.log("Tuition", tuition, "scholarship", scholarship, "rent", rent, "transpo", transportation, "uber", uber, "computer", computer, "phone", phone, "fines", fines, "internet", internet, "phonebill", phonebill, "utilities", utilities, "lunch", lunch, "groceries", groceries, "coffee", coffee, "hydration", hydration, "alcohol", alcohol, "onlineshopping", onlineshopping, "weddings", weddings, "birthdays", birthdays, "additional", additional, "healthcare", healthcare, "extrahealthcare", extrahealthcare);
...
function showMath() {
    ...
    $("#show-grandTotal").text(grandTotal);
